   ...
   */
    ...
    Class.prototype.render = function(){
        ...
        isStatic ? options.elem.append(elem) : (
            ...
            //zxb  更改插入位置
            document.getElementsByClassName('layui-body')[0].appendChild(elem)
                ,that.position() //定位
        );
    ...
    Class.prototype.position = function(){
        var that = this
            ...
            ,scrollArea = function(type){
                ...
                return document.getElementsByClassName('layui-body')[0][type] | document.documentElement[type];
            }
        ...
        that.elem.style.left = left + (options.position === 'fixed' ? 0 : scrollArea(1))-161 + 'px';
        that.elem.style.top = top + (options.position === 'fixed' ? 0 : scrollArea())-42 + 'px';
    };
    ...
    Class.prototype.events = function(){
        ...
        //绑定关闭控件事件 //zxb
        lay(document.getElementsByClassName('layui-body')[0]).on('click', function(e){
